...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {动态开辟空间 new / delete};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {类型转换 char chs[100]\{ 0 \}};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {动态数组 vector};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {哈希表 unordered\_map};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {哈希集合 unordered\_set};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {队列 queue};
\end{tikzpicture}
...
\end{verbatim}
  ...
  %-----------------------------------------
  \node[fancytitle, right=10pt] at (box.north west) {堆栈 stack};
\end{tikzpicture}
